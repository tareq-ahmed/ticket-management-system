...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/anna.jpg" alt="image">
      </div>
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post" class="updateprofileform">
           <div class="form-group">
            ...
            <div class="form-group">
              <input type="submit" value="Save Changes" name="updateprofile" id="submit" class="btn btn-block">
            </div>
          </form>
        </div>
      </div>
