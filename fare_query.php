    ...
    <div  class="row">
      ...
      <div class="col-md-6">
        <div class="contact_form" style='background-color:#4FAC03'>
          <form  method="post" action="fare_query_results.php">
            ...
            <div class="form-group">
              ...
              <select type="select" name="class" class="form-control gray_bg" id="class" required>
                <option value="all">All Classes</option>
                <option value="acfirst">AC First Class</option>
                <option value="first">First Class</option>
                <option value="seccond">Seccond Class</option>
              </select>
            </div>
            <div class="form-group" style='text-align:center'>
              <button class="btn" type="submit" name="search_fare" type="submit">Search Fares</button>
