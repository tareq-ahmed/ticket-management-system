...
if(isset($_POST['menu_search_btn']))
  {
$from=$_POST['menu_search'];
$to=$_POST['menu_search'];
$date=$_POST['menu_search'];
$today=date("Y-m-d");
}
else{
...
<?php 
$sql = "SELECT * from  tblschedule where ST_From='$from' or ST_To='$to' or JR_Date='$date'";
...
{ ?>
        ...
        <div class="panel-heading" style='background-color:#4FAC03'>Schedule</div>
...
{       ?>        
                    ...
                    <tr>
                      ...
                      <td><a href="#" style='display:block'>Buy Tickets</a></td>
                    <?php $cnt=$cnt+1; }}
                    else{echo "<h4 style='color:darkred'>Sorry! No Results!</h4>";} ?>
                    </tbody>
                    </table>
                    </div>
                    </div>
